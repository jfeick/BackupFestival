...
public class FilmsRecyclerViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_films_recyclerview, container, false);
    ...
    public static FilmsRecyclerViewFragment newInstance() {
        FilmsRecyclerViewFragment fragment = new FilmsRecyclerViewFragment();
        return fragment;
    }
